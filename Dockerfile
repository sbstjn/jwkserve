...
RUN --mount=type=bind,source=./src/target/aarch64-unknown-linux-gnu/release,target=/mnt/arm \
    --mount=type=bind,source=./src/target/x86_64-unknown-linux-gnu/release,target=/mnt/x86 \
